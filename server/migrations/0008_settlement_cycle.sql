...
ALTER TABLE settlement_records ADD COLUMN settle_at TIMESTAMPTZ NULL;
...
CREATE INDEX idx_settlement_records_settle ON settlement_records(status, settle_at) WHERE status = 'pending';
