...
func CreateChannel(r *ghttp.Request) {
	...
	in.CreatedByUserID = middleware.GetUserID(r)
...
func ReviewChannel(r *ghttp.Request) {
	...
	in.ReviewerID = middleware.GetUserID(r)
...
func ListModelPrices(r *ghttp.Request) {
	...
	if modelSpecID == 0 {
		r.Response.WriteStatusExit(400, map[string]any{"code": 400, "message": "invalid model spec id"})
		return
	}
